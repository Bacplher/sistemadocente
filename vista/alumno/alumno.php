    ...
    <center><table border="1" align="center" class='rwd-table'>
        ...
        <?php for($i = 0; $i < count($this->alumnos); $i++): ?>
            ...
            <tr >
                ...
                <td>
                    <a href="javascript:void(0)" onclick="editar('<?php echo BASE_URL?>alumno/editar/<?php echo $this->datos[$i]['IdAlumno'] ?>')" class="imgedit"></a>
                    <a href="javascript:void(0)" onclick="eliminar('<?php echo BASE_URL?>alumno/eliminar/<?php echo $this->datos[$i]['IdAlumno'] ?>')" class="imgdelete"></a>
